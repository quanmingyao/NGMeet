...
Output_dir    =   ['Results/Denoising_results/nsig_',num2str(nSig)];
% mkdir(Output_dir); 
pre           =   'All_Denoising_';
...
%     ERGAS_SSTV = ErrRelGlobAdimSyn(O_Img, SSTV_Img);
    fprintf( sprintf('%s: PSNR_SSTV = %3.2f  SSIM_SSTV = %f SAM_SSTV = %f   /n', im_dir(i).name, PSNR_SSTV, SSIM_SSTV, SAM_SSTV ) );
    fprintf(fd_txt, '%s : PSNR_SSTV = %2.2f  SSIM_SSTV = %2.4f SAM_SSTV = %f  /n', im_dir(i).name, PSNR_SSTV, SSIM_SSTV, SAM_SSTV);               
...
%     ERGAS_TDL = ErrRelGlobAdimSyn(O_Img, 256*TDL_Img);
    fprintf( sprintf('%s: PSNR_TDL = %3.2f  SSIM_TDL = %f SAM_TDL = %f   n', im_dir(i).name, PSNR_TDL, SSIM_TDL, SAM_TDL ) );
    fprintf(fd_txt, '%s : PSNR_TDL = %2.2f  SSIM_TDL = %2.4f SAM_TDL = %f  /n', im_dir(i).name, PSNR_TDL, SSIM_TDL, SAM_TDL);   
...
%     fprintf( sprintf('%s: PSNR_ISTReg = %3.2f  SSIM_ISTReg = %f SAM_ISTReg = %f  /n', im_dir(i).name, PSNR_ISTReg, SSIM_ISTReg, SAM_ISTReg ) );
%     fprintf(fd_txt, '%s : PSNR_ISTReg = %2.2f  SSIM_ISTReg = %2.4f SAM_ISTReg = %f  /n', im_dir(i).name, PSNR_ISTReg, SSIM_ISTReg, SAM_ISTReg);
...
%     ERGAS_LLRT = ErrRelGlobAdimSyn(O_Img, E_Img);
    fprintf( sprintf('%s: PSNR_LLRT = %3.2f  SSIM_LLRT = %f SAM_LLRT = %f  /n', im_dir(i).name, PSNR_LLRT, SSIM_LLRT, SAM_LLRT ) );
    fprintf(fd_txt, '%s : PSNR_LLRT = %2.2f  SSIM_LLRT = %2.4f SAM_LLRT = %f  /n', im_dir(i).name, PSNR_LLRT, SSIM_LLRT, SAM_LLRT);      
